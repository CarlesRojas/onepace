    ...
    return (
        <div className="w-full h-fit px-4 sm:px-8 flex gap-1 sm:gap-2 justify-between absolute z-10 top-3 sm:top-10">
            <button
                ...
                } group p-3 sm:p-4 w-14 h-12 sm:h-14 rounded-full touch:hidden flex items-center justify-center outline-none focus:scale-110 hover:scale-110 active:scale-105 transition-all border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-black !bg-opacity-80 backdrop-blur-md shadow-sm`}
                onClick={() => goPrev()}
                type="button"
                    ...
                    <button
                        className={`${
                            ...
                            (firstNotWatched <= cleanLastVisible.current &&
                                ...
                                : ''
                        } group p-3 sm:p-4 w-fit h-12 sm:h-14 rounded-full flex items-center justify-center gap-2 outline-none focus:scale-110 hover:scale-110 active:scale-105 border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-black !bg-opacity-80 backdrop-blur-md shadow-sm`}
