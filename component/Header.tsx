...
export default function Header() {
    ...
    const links = (
        <div className="relative gap-2 flex w-fit h-full items-center justify-center">
            ...
            <a
                ...
                className={
                    'group w-12 h-12 p-3 cursor-pointer transition-transform outline-none pointer:hover:text-blue-500 pointer:hover:scale-110 pointer:focus-visible:scale-110 pointer:focus-visible:text-blue-500 active:scale-105 rounded-full border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-black !bg-opacity-80 backdrop-blur-md shadow-sm'
                }
                data-tooltip-id="tooltip"
    ...
    return (
        <header className="sticky z-40 top-0 left-0 w-full h-24 flex gap-2 sm:gap-4 justify-between items-center py-4 px-4 md:px-8 bg-neutral-50 dark:bg-neutral-925 border-b border-b-neutral-200 dark:border-b-neutral-900">
            <a
                href="/"
            ...
            <a
                ...
                } group gap-2 items-center w-12 h-12 p-3 cursor-pointer transition-transform outline-none pointer:hover:text-blue-500 pointer:hover:scale-110 pointer:focus-visible:scale-110 pointer:focus-visible:text-blue-500 active:scale-105 rounded-full border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-black !bg-opacity-80 backdrop-blur-md shadow-sm`}
                href="/"
                aria-label="Back"
                data-tooltip-id="tooltip"
            ...
            <button
                className={
                    'flex md:hidden items-center justify-center w-12 h-12 p-3 cursor-pointer transition-transform outline-none pointer:hover:text-blue-500 pointer:hover:scale-110 pointer:focus-visible:scale-110 pointer:focus-visible:text-blue-500 active:scale-105 rounded-full border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-black !bg-opacity-80 backdrop-blur-md shadow-sm'
                }
                type="button"
